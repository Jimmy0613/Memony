<script lang="ts">
    ...
    import { onMount } from 'svelte';
      ...
      onMount(() => {
        ...
        easingScript.src = '/vendor/jquery-easing/jquery.easing.min.js';
        easingScript.defer = true;
        document.body.appendChild(easingScript);

        // Custom template JS
        const templateScript = document.createElement('script');
        templateScript.src = '/js/sb-admin-2.min.js';
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="text-center d-none d-md-inline">
            <button class="rounded-circle border-0" id="sidebarToggle" aria-label="..."></button>
        </div>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3" aria-label="...">
